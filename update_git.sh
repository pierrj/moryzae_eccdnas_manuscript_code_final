...
cp moryzae_eccdnas_manuscript_analysis_and_plots/effectors_on_eccdnas/avrpita3_on_eccdna.Rmd ecc_calling_illumina/avrpita3_on_eccdna.Rmd
cp KVK-lab-scripts/slurm/avrpita3_on_eccdna_figure.slurm ecc_calling_illumina/avrpita3_on_eccdna_figure.slurm

cp KVK-lab-scripts/slurm/histone_marks_never_v_common.slurm eccdna_associated/expression_genome_marks/histone_marks_never_v_common.slurm
cp moryzae_eccdnas_manuscript_analysis_and_plots/gene_analysis/neverfound_genes/histone_marks/histone_marks_plot_profile_never.Rmd eccdna_associated/expression_genome_marks/histone_marks_plot_profile_never.Rmd
cp KVK-lab-scripts/slurm/expression_never_v_common.slurm eccdna_associated/expression_genome_marks/expression_never_v_common.slurm
