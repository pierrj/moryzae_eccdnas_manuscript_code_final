...
p1 <- ggplot(df, aes(x=distance_five, y=distance_three)) +  
  ...
  annotation_logticks() +
  scale_x_continuous(breaks=0:5, labels=c("0.01", "0.01", "0.1", "1", "10", "100"), limits = c(2,4.5)) +
...
p2 <- ggplot(df[df$effector == TRUE,], aes(x=distance_five, y=distance_three)) +  
  ...
  geom_segment(aes(x=x_int,xend=x_int,y=Inf,yend=y_int), size =0.5, linetype='dashed') +
  geom_segment(aes(x=Inf,xend=x_int,y=y_int,yend=y_int), size =0.5, linetype='dashed') +
  geom_text(data = known_effectors_table, aes(x=distance_five, y=distance_three, label=known_effector_name), size =3) +
  xlab("5' Distance to nearest gene (kbp)") + ylab("3' Distance to nearest gene (kbp)") +
  annotation_logticks() +
  scale_x_continuous(breaks=0:5, labels=c("0.01", "0.01", "0.1", "1", "10", "100"), limits = c(2,4.5)) +
  scale_y_continuous(breaks=0:5, labels=c("0.01", "0.01", "0.1", "1", "10", "100"), limits = c(2,4.5)) +
...
ggsave("two_speed_genome_analysis_gene_distance_all_genes.pdf", plot = p1x, width = 3.25, height = 3.25)

ggsave("two_speed_genome_analysis_gene_distance_effectors.pdf", plot = p2x, width = 3.25, height = 3.25)

ggsave("two_speed_genome_analysis_gene_distance_never_found_genes.pdf", plot = p3x, width = 3.25, height = 3.25)

ggsave("two_speed_genome_analysis_gene_distance_commonly_found_genes.pdf", plot = p4x, width = 3.25, height = 3.25)
