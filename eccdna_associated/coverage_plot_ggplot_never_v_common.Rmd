...
known_genes_table[known_genes_table$name_70_15 == 'PTP2',]

known_genes_table[known_genes_table$gene == 'gene_05579.t1',]

df[df$gene == 'gene_05579.t1',]


known_genes_table[known_genes_table$name_70_15 == 'MYO1',]
...
p1 <- ggplot() + 
  ...
  geom_segment(aes(x=0, xend=(sum(v[1:1]) - v[1] + sum(v[1:end_subset_first_few])), y=log10(common_genes_cutoff), 
      ...
      geom_text_repel(data = known_genes_table_absent, aes(x=BASE_TOTAL, y=splitreads, label=name_70_15), size =2, min.segment.length = 0, max.overlaps = 100, segment.linetype = 2, force = 0.075) +
